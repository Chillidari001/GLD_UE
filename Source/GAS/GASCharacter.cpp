...
void AGASCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	//Sprinting
	PlayerInputComponent->BindAction("Sprint", IE_Pressed, this, &AGASCharacter::SprintStart);
	PlayerInputComponent->BindAction("Sprint", IE_Released, this, &AGASCharacter::SprintEnd);
	
	//Interaction
	PlayerInputComponent->BindAction("Interact",IE_Pressed, this, &AGASCharacter::OnInteract);
...
void AGASCharacter::InitialiseAttributes()
{
...
void AGASCharacter::SprintStart()
{
	IsSprinting = true;
	GetCharacterMovement()->MaxWalkSpeed = SprintSpeed;
}

void AGASCharacter::SprintEnd()
{
	IsSprinting = false;
...
void AGASCharacter::OnInteract()
{
	...
	{
		this->SetActorLocation(FinalPorter->GetActorLocation());
	}
}